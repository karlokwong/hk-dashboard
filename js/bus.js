...
const PRESET_STOPS = [
  ...
  { operator:'KMB', id:'F41714406F2D4E00', label:'青衣碼頭總站',       route:'49X', serviceType:1, dir: 'I',hint:'往沙田' },
...
async function renderMiniBusPreset() {
  const container = document.getElementById('mini-preset-bus-container');
...
// 註冊至全域
window.renderMiniBusPreset = renderMiniBusPreset;
